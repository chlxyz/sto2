        ...
        @else
            @foreach($orders as $order)
                <div class="bg-white shadow-md rounded-md p-6 mb-6">
                    ...
                    <p class="text-lg font-semibold">Costumer ID: <span class="text-gray-700">{{ $order->user_id }}</span></p>
                    <p class="text-lg font-semibold">Costumer Name: <span class="text-gray-700">{{ $order->user->name }}</span></p>
